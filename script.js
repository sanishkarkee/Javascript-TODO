// ---- Check if data is in localstorage or not ----
...
//yo click garda save,cancel, text area visible hunu paryo
...
function activateCancelListners() {
  ...
  const upadateController = document.querySelectorAll('.update-controller')
  const inputs = document.querySelectorAll('.input-controller textarea')

  cancelBtn.forEach((cb, i) => {
    cb.addEventListener('click', () => {
      upadateController[i].style.display = 'none'
